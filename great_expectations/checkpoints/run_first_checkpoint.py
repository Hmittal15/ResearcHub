...
Usage:
- Run this file: `python great_expectations/uncommitted/run_first_checkpoint.py`.
...
data_context: FileDataContext = get_context(
    context_root_dir="/home/ananthakrishnan/Desktop/New Folder 1/trial2/ResearcHub/great_expectations"
)
